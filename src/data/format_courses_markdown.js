...
const destPath = path.join('c:', 'Users', 'OWNER', 'Documents', 'Genomac', 'Certifyer', 'academy', 'src', 'data', 'courses.ts');
...
*   **Monday (Video)**:  
    *Topic:* “Why are certificates still so stressful to create?”
*   **Friday (Text/Carousel)**:  
    *Topic:* “A certificate is more than a piece of paper.”

### Week 2 — Help People Relate
*   **Monday (Text/Meme)**:  
    *Topic:* “Things every organization that creates certificates understands 😂”
*   **Friday (Feature Show)**:  
    *Topic:* “Meet Certifyer: making certificate creation easier for organizations.”

### Week 3 — Show the Solution
*   **Monday (Demo/Process)**:  
    *Topic:* “From a list of names to professional certificates — in a simpler way.”  
    *(Show product/demo screenshots or process)*
*   **Friday (Benefits)**:  
    *Topic:* “3 reasons organizations are moving towards digital certificates”

### Week 4 — Introduce the Bigger Vision
*   **Monday (Video)**:  
    *Topic:* “The future of certificates is bigger than a PDF.”
*   **Friday (Vision)**:  
    *Topic:* “What if your certificate could do more?”

### Week 5 — Build Authority & Create Anticipation
*   **Post 9**:  
    *Topic:* “Who can use Certifyer?”  
    *Mention:* Training providers, companies, schools, communities, and event organizers.
*   **Post 10**:  
    *Topic:* “The reason we’re building Certifyer”  
    *Storytelling post:* Problem → Idea → Mission.
*   **Monday**:  
    *Topic:* “Something bigger is coming to Certifyer 👀”  
    *Note:* Tease future features without fully announcing. Introduce a bit about monetization.
*   **Friday**:  
    *Topic:* “We believe achievements deserve more than a certificate.” OR “We’re building the future of digital recognition. Are you ready?”  
    *Note:* Talk about how beneficial the monetization process or output of Certifyer is to them.
`
      }
    ]
  }
...
// Compile TS code and write file
const tsContent = `export interface Exercise {
  id: string;
...
export const mockCourses: Course[] = [
  {
    ...
    difficulty: 'Beginner',
    modules: ${JSON.stringify(modulesData, null, 2)}
  }
];
`;

fs.writeFileSync(destPath, tsContent, 'utf8');
console.log('Courses data compiled and formatted successfully!');
